...
// {{SRC
wp_enqueue_script("pageScripts", $tpldir ."/js/scripts-page.js", array('jquery', 'bones-common'), '', true );
// SRC}}

/* {{DEST
wp_enqueue_script("pageScripts", $tpldir ."/js/scripts-page.min.js", array('jquery', 'bones-common'), '', true );
DEST}} */

$id = get_the_ID();
$script = get_post_meta($id, 'js', true);
if ($script) wp_enqueue_script("page" .$id, $tpldir ."/js/" .$script, array('jquery', 'bones-common'), '', true );
